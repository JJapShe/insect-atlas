...
const record = (id, koreanName, scientificName, order, family, habitat, diet, cues, familiarityLevel = 2) => Object.freeze({
  ...
  gallery: [], sources: source, licenseStatus: "이미지 미배정", reviewStatus: "draft", access: "free",
});
