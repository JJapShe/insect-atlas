...
const expected = new Map([
  ...
  ["tools/generation-tests/priority-gallery-20260922-d.json", 5],
  ["tools/generation-tests/priority-gallery-20260922-e.json", 5],
  ["tools/generation-tests/priority-gallery-20260922-f.json", 4],
  ["tools/generation-tests/priority-new-friends-20260922.json", 2],
  ["tools/generation-tests/priority-life-cycle-20260922.json", 4],
  ["tools/generation-tests/priority-life-cycle-20260922-b.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260922-c.json", 4],
  ["tools/generation-tests/priority-new-friends-20260922-b.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260922-d.json", 1],
  ["tools/generation-tests/priority-gallery-20260922-g.json", 1],
  ["tools/generation-tests/priority-new-friends-20260922-c.json", 3],
  ["tools/generation-tests/priority-new-friends-20260922-d.json", 3],
  ["tools/generation-tests/priority-new-friends-20260922-e.json", 3],
  ...
  ["tools/generation-tests/priority-life-cycle-20260922-i.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260922-j.json", 1],
  ["tools/generation-tests/priority-new-friends-20260926-a.json", 4],
  ["tools/generation-tests/priority-life-cycle-20260926-a.json", 1],
  ["tools/generation-tests/priority-gallery-20260926-a.json", 1],
  ["tools/generation-tests/priority-gallery-20260926-b.json", 1],
  ["tools/generation-tests/priority-gallery-20260926-c.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260926-b.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260926-c.json", 1],
  ["tools/generation-tests/priority-gallery-20260926-d.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260926-d.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260926-e.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260926-f.json", 1],
  ["tools/generation-tests/priority-life-cycle-20260927-a.json", 1],
]);
...
assert.equal(publicGalleryRecords.length, 107, "public gallery review sources and unresolved public fallbacks must stay registered");
