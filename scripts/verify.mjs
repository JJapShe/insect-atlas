...
if (!Array.isArray(insects) || insects.length !== 138 || new Set(insects.map((insect) => insect.id)).size !== 138 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds, ...priorityRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 138 unique records, including priority representative images.");
