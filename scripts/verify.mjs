...
const priorityRepresentativeIds = new Set(["meloimorpha-japonica", "gryllus-bimaculatus", "oecanthus-longicauda", "polistes-chinensis-antennalis", "hydropsyche-orientalis", "papilio-maackii", "titanus-giganteus", "phalacrognathus-muelleri", "actias-luna", "megasoma-elephas", "myrmecocystus-mexicanus", "pepsis-grossa"]);
...
if (!Array.isArray(insects) || insects.length !== 129 || new Set(insects.map((insect) => insect.id)).size !== 129 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 129 unique records, including new-friend representative images.");
