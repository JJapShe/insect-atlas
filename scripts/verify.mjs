...
const priorityRepresentativeIds = new Set(["meloimorpha-japonica", "gryllus-bimaculatus", "oecanthus-longicauda", "polistes-chinensis-antennalis", "hydropsyche-orientalis", "papilio-maackii", "titanus-giganteus", "phalacrognathus-muelleri"]);
