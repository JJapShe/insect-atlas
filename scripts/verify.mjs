...
if (!Array.isArray(insects) || insects.length !== 134 || new Set(insects.map((insect) => insect.id)).size !== 134 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds, ...priorityRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 134 unique records, including priority representative images.");
