...
if (!Array.isArray(insects) || insects.length !== 136 || new Set(insects.map((insect) => insect.id)).size !== 136 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds, ...priorityRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 136 unique records, including priority representative images.");
