...
if (insects.some((insect) => insect.gallery.length && ![4, 5, 6, 7].includes(insect.gallery.length) && !(newFriendRepresentativeIds.has(insect.id) && [1, 2, 3].includes(insect.gallery.length)))) throw new Error("Illustrated species must retain four standard images, except staged new-friend galleries.");
