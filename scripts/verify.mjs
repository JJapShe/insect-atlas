...
if (!Array.isArray(insects) || insects.length !== 137 || new Set(insects.map((insect) => insect.id)).size !== 137 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds, ...priorityRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 137 unique records, including priority representative images.");
