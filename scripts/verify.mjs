...
if (!Array.isArray(insects) || insects.length !== 133 || new Set(insects.map((insect) => insect.id)).size !== 133 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds, ...priorityRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 133 unique records, including priority representative images.");
