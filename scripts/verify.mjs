...
const newFriendExtraCounts = new Map([["cerura-felina", 2], ["chrysiridia-rhipheus", 2], ["theraphosa-blondi", 2], ["mymaridae", 2], ["dipentium-japonicum", 2], ["pulex-irritans", 2], ["monomorium-chinense", 2], ["brephidium-exilis", 2]]);
