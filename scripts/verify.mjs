...
if (!Array.isArray(insects) || insects.length !== 139 || new Set(insects.map((insect) => insect.id)).size !== 139 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds, ...priorityRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 139 unique records, including priority representative images.");
