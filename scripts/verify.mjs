...
if (!Array.isArray(insects) || insects.length !== 140 || new Set(insects.map((insect) => insect.id)).size !== 140 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds, ...priorityRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 140 unique records, including priority representative images.");
