...
if (!Array.isArray(insects) || insects.length !== 141 || new Set(insects.map((insect) => insect.id)).size !== 141 || [...familiarLocalIds, ...rareFamousIds, ...familiarNextIds, ...newFriendRepresentativeIds, ...priorityRepresentativeIds].some((id) => !insects.some((insect) => insect.id === id))) throw new Error("Production data must contain 141 unique records, including priority representative images.");
